...
{
    if (wl_proxy_get_version((struct wl_proxy *)dmabuf->zwp_linux_dmabuf_v1) >=
...
static struct wayland_dmabuf_format *dmabuf_format_array_add_format_modifier(struct wl_array *formats,
                                                                             uint32_t format,
                                                                             uint64_t modifier)
{
    struct wayland_dmabuf_format *dmabuf_format;
