...
extern void invalidate_vk_surfaces( HWND hwnd ) DECLSPEC_HIDDEN;
...
extern void update_client_window( HWND hwnd, Window new_active, BOOL offscreen ) DECLSPEC_HIDDEN;
extern void detach_client_window( HWND hwnd, Window window ) DECLSPEC_HIDDEN;
